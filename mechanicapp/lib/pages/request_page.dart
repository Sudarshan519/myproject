...
import 'package:mechanicapp/pages/map.dart';
import 'package:mechanicapp/pages/profile.dart';
                                        ...
                                        children: [
                                          ...
                                          InputChip(
                                              ...
                                              onPressed: () {
                                                ...
                                                //     .delete();
                                                Get.to(CustomMap(
                                                  mylatitude: double.parse(
                                                      snapshot.data.docs[i]
                                                          .data()['latitude']),
                                                  mylongitude: double.parse(
                                                      snapshot.data.docs[i]
                                                          ['longitude']),
                                                ));
                                              },
